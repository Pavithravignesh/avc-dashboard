...
function AcvRDonutChart({ data, width = 300, height = 300 }) {
  const ref = useRef();
  ...
  useEffect(() => {
    ...
    const arcs = g.selectAll("g").data(pie(data)).enter().append("g");
    ...
    arcs.each(function (d) {
      ...
      const posC = [x + (midAngle > Math.PI ? -labelOffset : labelOffset), y]; // horizontal
      ...
      group
        ...
        .text(
          `${formatK(d.data.value)} (${Math.round(
