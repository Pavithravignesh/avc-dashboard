...
function CusTyStackedBarChart({ data, width = 600, height = 400 }) {
  ...
  useEffect(() => {
    ...
    xAxisG.selectAll("path,line").attr("stroke", theme.palette.text.secondary); // theme-aware
    ...
    yAxisG.selectAll("path,line").attr("stroke", theme.palette.text.secondary); // theme-aware
