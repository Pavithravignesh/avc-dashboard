...
const jsonData = JSON.parse(fs.readFileSync(path.join(__dirname, 'rawData', 'accountIndustry.json'), 'utf8'));
...
const accountIndustryData = jsonData.map((item) => ({
  ...item
}));

// ES6 export for use in Express routes/controllers
export default accountIndustryData;
